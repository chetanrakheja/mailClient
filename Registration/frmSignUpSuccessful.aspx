                     ...
                     <table  cellpadding="2" cellspacing="2" style="width: 100%;">
                         ...
                         <tr>
                             ...
                             <td align="left" style="font-weight: bold; color: black">
                                 <asp:TextBox ID="txtUserName" runat="server" ValidationGroup="g1"></asp:TextBox>@chetanrakheja.com<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUserName"
                         ...
                         <tr>
                             <td align="center" colspan="2" style="font-weight: bold; color: #ffffff">
                                 <asp:Button ID="btnSignUp" runat="server" OnClick="btnSignUp_Click" Text="Sign In"
                                     ValidationGroup="g1" />
                             </td>
                         </tr>
                         <tr>
